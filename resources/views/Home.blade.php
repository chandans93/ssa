        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="{{ asset('/')}}" class="logo">S S A</a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                ...
                <h2>SANSKARDHAM<em> SPORTS ACADEMY</h2>
                <div class="main-button scroll-to-section">
                    <a href="{{ asset('/enquiry')}}">Become a member</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div id="map">
                      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14687.318496554057!2d72.43142692508545!3d23.03002710490006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e9958a62e71a9%3A0xd6d52d4f3ba722e7!2sSanskardham%20Play%20Ground%2C%20Gujarat%20380058!5e0!3m2!1sen!2sin!4v1628941297199!5m2!1sen!2sin&output=embed" width="100%" height="600px" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-xs-12">
