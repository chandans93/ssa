...
<section class="content-header">
    <h1>
        ...
        <div class="col-md-2">
            <a href="{{ url('admin/addrewardconversation') }}" class="btn btn-block btn-primary add-btn-primary pull-right">{{trans('adminlabels.add')}}</a>
        </div>       
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body">
                    <table id="RCListingTable" class="table table-striped">
                        <thead>
                            <tr class="filters">                                                                
                                <th>{{trans('adminlabels.rc_reward_point')}}</th>
                                <th>{{trans('adminlabels.rc_voucher')}}</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var table = $('#RCListingTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('.getRewardConversation') !!}',
            columns: [
                {data: 'vrc_reward_point', name: 'vrc_reward_point'},
                {data: 'vrc_voucher', name: 'vrc_voucher'},
