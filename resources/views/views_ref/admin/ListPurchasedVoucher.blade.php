...
<section class="content-header">
    <h1>
        <div class="col-md-10">
            {{trans('adminlabels.formlblepruchasevoucher')}}
        </div>  
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
			...
			<form id="searchPurchaseVoucherHistory" action="{{ url('admin/purchasevoucher')}}" method="get">
     ...
     <table id="NewscommentListingTable" class="table table-striped">
                        <thead>
                            ...
                            <tr>
								...
								<th>{{trans('adminlabels.formlbletotalspentvoucher')}}</th>
                                <th>{{trans('adminlabels.formlblepurchasetvoucherdate')}}</th>
                            </tr>
