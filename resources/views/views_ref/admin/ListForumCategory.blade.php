...
<section class="content-header">
    <h1>
        ...
        <div class="col-md-2">
            <a href="{{ url('admin/addforumcategory') }}" class="btn btn-block btn-primary add-btn-primary pull-right">{{trans('adminlabels.add')}}</a>
        </div>       
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body">
                    <table id="forumcategoryTable" class="table table-striped">
                        <thead>
                            <tr class="filters">                                                                
                                <th>{{trans('adminlabels.forfc_name')}}</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var table = $('#forumcategoryTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('.getforumcategory') !!}',
            columns: [
                {data: 'fc_name', name: 'fc_name'},
