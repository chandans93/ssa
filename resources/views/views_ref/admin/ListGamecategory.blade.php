...
<section class="content-header">
    <h1>
        ...
        <div class="col-md-2">
            <a href="{{ url('admin/addgamecategory') }}" class="btn btn-block btn-primary add-btn-primary pull-right">{{trans('adminlabels.add')}}</a>
        </div>       
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-body">
                    <table id="gamecategoryTable" class="table table-striped">
                        <thead>
                            <tr class="filters">                                                                
                                <th>{{trans('adminlabels.formlblegamettitle')}}</th>
                                <th>{{trans('adminlabels.formlblegameparentcategory')}}</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var table = $('#gamecategoryTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! route('.getgamecategory') !!}',
            columns: [
		{data: 'gc_title', name: 'gc_title'},
