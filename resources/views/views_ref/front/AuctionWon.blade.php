...
<div class="prev_purchased_item">
    <div class="container">
        ...
        <div class="alien_ufo_header">
            <h2>Auction Won Item</h2>
        </div>
        <div class="prev_purchased_item_inner">
            <div class="row">
                
                @forelse($wonAuctionDetails as $wonAuctionDetail)
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="purchased_item">
                        <img src="{{ asset($imagePath.'/'.$wonAuctionDetail->pi_image_name) }}"  alt="purchase_item1" class="img-responsive">
                    </div> <!-- purchased_item End -->
                    <p><a href="{{url('productdetail/'.$wonAuctionDetail->id)}}">{{$wonAuctionDetail->p_title}}</a></p>
